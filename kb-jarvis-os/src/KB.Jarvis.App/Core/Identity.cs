...
public static class Identity
{
    ...
    {
        "english" or "en" => "I was designed and developed by KB — Khuda Bakhsh. I am his personal AI operating assistant.",
        "urdu" or "ur" => "مجھے کے بی — خدا بخش نے ڈیزائن اور ڈیولپ کیا ہے۔ میں ان کا ذاتی اے آئی آپریٹنگ اسسٹنٹ ہوں۔",
        _ => "Mujhe KB — Khuda Bakhsh ne design aur develop kiya hai. Main unka personal AI operating assistant hoon."
    };
}
